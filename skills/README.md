...
| 技能 | 描述 |
|------|------|
| `deep-research/` | 13-agent 深度学术调研（7 种模式：完整/简报/文献综述/事实核查/苏格拉底引导等） |
| `academic-paper/` | 12-agent 论文写作（10 种模式：大纲/摘要/引言/方法/实验/讨论/审稿回复/引用检查/AI 套话过滤等） |
| `academic-paper-reviewer/` | 7-agent 同行评审模拟（EIC + 3 评审 + 魔鬼代言人） |
| `academic-pipeline/` | 全流程编排：调研→写作→完整性检查→评审→修改→终审→定稿 |
