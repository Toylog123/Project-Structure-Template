...
% 图路径：数据图在 data/final/，手工图在 manual/final/（figures 分两类）
\graphicspath{{../figures/data/final/}{../figures/manual/figures/}}
...
% 结语（两字标题加自然空；回答三问：机制→问题→结果→边界 + 一句未来工作；非模块/实验流水账）
\section{结\quad 语}
{结语：靠什么机制解决了什么问题 → 带来什么结果（多好）→ 边界在哪；结尾一句简短未来工作（期刊要求）。}
